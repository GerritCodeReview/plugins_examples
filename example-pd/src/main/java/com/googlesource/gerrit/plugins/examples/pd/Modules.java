  ...
  public static class Module extends AbstractModule {
    ...
    protected void configure() {
      ...
      bind(ChangePluginDefinedInfoFactory.class)
          ...
          .to(PdAttributeFactory.class);
    }
  }

  public static class PdAttributeFactory implements ChangePluginDefinedInfoFactory {
    protected final SharedPluginEnv sharedPluginEnv;

    @Inject
    public PdAttributeFactory(SharedPluginEnv sharedPluginEnv) {
        ...
        PdAttribute pdAttribute =
            (PdAttribute)
                sharedPluginEnv
                    ...
                    .instantiate("com.googlesource.gerrit.plugins.examples.pd.PdAttributeImpl");
        return pdAttribute.createPluginDefinedInfos(
            cds, (Modules.MyQueryOptions) beanProvider.getDynamicBean(plugin));
