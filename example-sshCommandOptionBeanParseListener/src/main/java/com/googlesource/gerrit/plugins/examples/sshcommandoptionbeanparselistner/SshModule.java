...
package com.googlesource.gerrit.plugins.examples.sshcommandoptionbeanparselistner;
...
public class SshModule extends AbstractModule {
  ...
  public static class BanOptions implements DynamicOptions.DynamicBean,
    ...
    @Option(name = "--hammer", aliases = { "-h" }, usage = "Log BANHAMMER error messages")
    private void parse(String arg) {
      log.error("!BANHAMMER! - option parse: " + arg);
    }

    @Override
    public void onBeanParseStart(String plugin, Object bean) {
      log.error("!BANHAMMER! - parse start");
    }

    @Override
    public void onBeanParseEnd(String plugin, Object bean) {
      log.error("!BANHAMMER! - parse end");
    }
