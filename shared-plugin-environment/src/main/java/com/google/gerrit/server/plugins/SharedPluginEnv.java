...
import com.googlesource.gerrit.plugins.sharedenvironment.MultiParentClassLoader;
import com.googlesource.gerrit.plugins.sharedenvironment.PluginProvidedApi;
import com.googlesource.gerrit.plugins.sharedenvironment.SharedPluginProvider;
...
public class SharedPluginEnv {
  ...
  protected SharedPluginProvider pluginProvider;
  protected Properties properties;

  private Injector rootInjector;

  @Inject
  public SharedPluginEnv(SharedPluginProvider pluginProvider) {
  ...
  protected Injector getInjector() {
    ...
    String targetPluginName = properties.injectorFromPlugin;
    Plugin targetPlugin = pluginProvider.getPlugin(targetPluginName);
    return targetPlugin.getSysInjector();
  }
  ...
  protected ClassLoader getPluginClassLoader(String pluginName) throws NoSuchPluginException {
    Plugin plugin = pluginProvider.getPlugin(pluginName);
    if (plugin instanceof SharedServerPlugin) {
      return ((SharedServerPlugin) plugin).getClassLoader();
    }
  ...
  public Injector getRootInjector(PluginGuiceEnvironment env) {
          ...
          Guice.createInjector(
              ...
              new AbstractModule() {
                ...
                protected void configure() {
                  bind(SharedPluginEnv.class).toInstance(SharedPluginEnv.this);
